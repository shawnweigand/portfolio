        ...
        <header className="flex flex-col items-center justify-center h-screen bg-cover bg-center">
            ...
            <div className="flex gap-4 my-8">
                ...
                <a href="https://github.com/shawnweigand" target="_blank" className="block col-span-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-[#799B62] hover:opacity-75 transition-opacity duration-200">
                ...
                <a href="https://www.linkedin.com/in/shawn-weigand/" target="_blank" className="block col-span-1 mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-10 h-10 text-[#799B62] hover:opacity-75 transition-opacity duration-200">
                ...
                <a href="https://x.com/theshawnshop" target="_blank" className="block col-span-1 mt-1">
                    <svg width="43" height="43" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hover:opacity-75 transition-opacity duration-200'>
                        <path d="M11.154 9.72955L7.08868 4.0412H4.92041L9.9563 11.0871L10.5902 11.9734L14.9006 18.0096H17.0689L11.7852 10.6159L11.154 9.72955Z" fill="#799B62"/>
                        <path d="M20.1598 0H1.84021C0.823853 0 0 0.823853 0 1.84021V20.1598C0 21.1761 0.823853 22 1.84021 22H20.1598C21.1761 22 22 21.1761 22 20.1598V1.84021C22 0.823853 21.1761 0 20.1598 0ZM14.2354 19L9.8728 12.787L4.41144 19H3L9.24689 11.8953L3 3H7.76465L11.8948 8.88196L17.0696 3H18.481L12.524 9.77563L19 19H14.2354Z" fill="#799B62"/>
                    </svg>
                </a>
                {/* TikTok */}
                <a href="https://www.tiktok.com/@theshawnshop" target="_blank" className="block col-span-1 mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-10 h-10 hover:opacity-75 transition-opacity duration-200">
                        <rect width="256" height="256" rx="48" fill="#799B62"/>
                        <path d="M164 64.6c9.2 7.7 20.5 12.7 33.1 13.7v26.6c-12.7-1-24-5.6-33.1-13.3v60.2c0 29.4-23.7 53.1-53.1 53.1S60.9 181.2 60.9 151.8s23.7-53.1 53.1-53.1c4.1 0 8.1.5 11.9 1.5v27.5c-3.8-1.5-7.8-2.3-11.9-2.3-14.2 0-25.7 11.5-25.7 25.7s11.5 25.7 25.7 25.7 25.7-11.5 25.7-25.7V48h28.3v16.6Z" fill="#fff"/>
                    </svg>
                </a>
            </div>

            <a href="#projects" className="px-8 py-4 bg-[#B79065] text-white rounded-md shadow-md hover:bg-[#AE8157]">
                View My Work
            </a>
    </header>
    )
