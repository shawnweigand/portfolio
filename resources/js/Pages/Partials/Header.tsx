...
export default function Header() {
    ...
    return (
        <header className="flex flex-col items-center justify-center h-screen bg-cover bg-center">
            ...
            <p className="text-xl text-[#2e250a] md:text-2xl -mt-4">Platform Engineer • Cloud • DevOps </p>
            ...
            <a href="#projects" className="px-8 py-4 bg-[#D0A37C] text-white rounded-md shadow-md hover:bg-[#AE8157]">
                View My Work
            </a>


        {/* <div className="flex flex-col items-center md:flex-row md:space-x-8 mb-8">
            ...
            <div className="text-center md:text-left">
                <div className='flex items-end'>
                    <h1 className="text-4xl text-[#2e250a] md:text-6xl font-bold mb-8">Hi, I'm</h1>
                    <img
                        src={signature}
                        alt="Shawn Weigand"
                        className="scale-75 -ml-24"
                    />
                </div>
                <p className="text-xl text-[#2e250a] md:text-2xl mb-3">Web Developer, Cloud Engineer, DevOps</p>
                <div className='flex place-self-center md:place-self-start'>
                    <MapPinIcon className='text-blue-600 w-12 h-12 mb-8'/>
                    <p className='text-lg text-[#2e250a] md:text-xl mt-3 ml-2'>Brooklyn, NY</p>
                </div>
